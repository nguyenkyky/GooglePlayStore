package com.betty.playerstore.data

import com.betty.playerstore.model.App

class DataSource {
    fun loadSocialApp(): List<App> {
        return listOf(
            App("Facebook", 1, 4.6f, false),
            App("Instagram", 1, 4.7f, false),
            App("Twitter", 2, 4.5f, false),
    ...
    fun loadPopularApp(): List<App> {
        return listOf(
            App("Traveloka", 0, 4.4f, false),
            App("Qatar Airway", 0, 4.6f, false),
            App("Vietjet Air", 0, 4.8f, false),
            App("Travel Planner", 0, 4.7f, false),
